...
public class ArrayListMain {
	...
	public static void main(String[] args) {
		...
		Object  getAccount = accountList.get(accountList.size()-1);
		...
		for (int i = 0; i < accountList.size(); i++) {
			Account tempAccount = accountList.get(i); // 한개찾는것은 이런부분에서는 불편함
		...
		Iterator<Account> accountIterator =  accountList.iterator(); // 반복자(iterator)를 나에게 달라
