...
<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  */
  ...
  /*
 	...
 	Guest guest = guestService.findByNo(no);
 	*/
 	...
 	if(guest == null ) {
 		...
 		out.println("	location.href='guest_main.jsp';"); // 다 메인으로 보냄, 나중에 수정하기
 		out.println("</script>");		
 		return;
 	}
 	
 	// <% 를 사용해서 작성해도 되지만 그러면 더 복잡해서 out.println() 을 사용해준다.
						...
						<td>
							...
							<form name="f" method="post">
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									bgcolor="BBBBBB"> <!-- 안보이는 데이터; 사용자에게 보여줄 필요 없으므로 hidden 을 사용 -->
									<tr>
