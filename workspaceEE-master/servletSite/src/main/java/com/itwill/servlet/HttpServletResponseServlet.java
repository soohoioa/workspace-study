...
public class HttpServletResponseServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		http://192.168.15.31/servletSite/response.do?cmd=3456789
		...
		if(cmd.equals("1")) {
			 ...
			 *  3.응답바디데이타 없음(보낼수없음)
			 */
			response.sendRedirect("./index.html"); // 절대, 상대 다 들어간다.
			// sendRedirect 는 우리눈에 안보이기때문에(바디가 없다) 방향만 있기때문에 헷갈릴수있다.
		}
